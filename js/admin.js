...
import { store } from './store.js?v=10.4.5';
import { exportPlayersToCSV, exportTeamsToCSV, exportPlayersToPDF } from './export.js?v=10.4.5';
import { openSquareImageCropModal, compressImage, openYouTubePromoModal } from './app_v9.js?v=10.4.5';
import { saveAdSettingsToFirebase, fetchAdSettingsFromFirebase, fetchPopupSettingsFromFirebase, savePopupSettingsToFirebase, uploadHDImage, getOptimizedImageUrl } from './supabase.js?v=10.4.5';
import { shops } from './shopsData.js?v=10.4.5';
