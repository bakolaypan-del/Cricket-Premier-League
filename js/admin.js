...
import { exportPlayersToCSV, exportTeamsToCSV, exportPlayersToPDF, exportTeamsToPDF, exportTeamFinalSquadToPDF, exportAllTeamsFinalSquadsToPDF, exportMatchScorecardPDF, exportMatchScorecardPNG, exportFullMatchSummaryPDF, exportAuctionSummaryPDF, exportPlayerSocialCard, openUserGuidePDF } from './export.js?v=13.0.80';
import { saveAdSettingsToCloud, fetchAdSettingsFromCloud, fetchPopupSettingsFromCloud, savePopupSettingsToCloud, uploadHDImage, getOptimizedImageUrl, syncTeamToSupabase, generateUUID, resolveTournamentUUID, registerTournamentUUID, toUUID, compressImageToTarget, saveScorecardsToSupabase } from './supabase.js?v=13.0.80';
...
function processScorerBall(runsScored) {
  ...
  fixture.status = 'LIVE';
  fixture.liveMatchState = state;
  fixture.liveState = state;

  if (typeof window !== 'undefined') {
    window.__cplLiveScores = window.__cplLiveScores || {};
    window.__cplLiveScores[fixture.id] = state;
    const uId = toUUID(fixture.id);
    if (uId) window.__cplLiveScores[uId] = state;
  }
