...
import { exportPlayersToCSV, exportTeamsToCSV, exportPlayersToPDF } from './export.js?v=10.4.0';
import { openSquareImageCropModal, compressImage, openYouTubePromoModal } from './app_v9.js?v=10.4.0';
import { saveAdSettingsToFirebase, fetchAdSettingsFromFirebase, fetchPopupSettingsFromFirebase, savePopupSettingsToFirebase, uploadHDImage, getOptimizedImageUrl } from './supabase.js?v=10.4.0';
