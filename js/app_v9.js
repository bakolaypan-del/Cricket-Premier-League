...
import { store } from './store.js?v=11.4.2';
import { exportPlayersToCSV, exportTeamsToCSV, exportPlayersToPDF, exportTeamsToPDF, printDigitalPass, openUserGuidePDF } from './export.js?v=11.4.2';
import { renderAdminDashboard } from './admin.js?v=11.4.2';
import { uploadHDImage, fetchAdSettingsFromFirebase, fetchPopupSettingsFromFirebase, getOptimizedImageUrl, initVisitorTracking, fetchVisitorStats } from './supabase.js?v=11.4.2';
import { shops } from './shopsData.js?v=11.4.2';
